...
class TestUnconstrainedRosenbrock(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sys = System(
            ...
            log_name="flume.log",
            log_prefix="tests/rosenbrock_unconstrained" + self.dir_suffix,
...
class TestConstrainedRosenbrock(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sys = System(
            ...
            log_name="flume.log",
            log_prefix="tests/rosenbrock_constrained" + self.dir_suffix,
            parallel_execution=self.parallel_execution,
        )
...
class TestThomsonProblem(unittest.TestCase):
    ...
    def construct_system(self, n_p):
        ...
        sys = System(
            ...
            log_prefix="tests/thomson_problem" + self.dir_suffix,
            parallel_execution=self.parallel_execution,
        )
